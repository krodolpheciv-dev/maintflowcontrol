    ...
    <div class="navbar-content">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1 ms-3 me-2">
              <h6 class="mb-0" data-i18n="App Gestion" style="color:white;" >App Gestion</h6>
              <small data-i18n="Administrateur" style="color:white;" >Administrateur</small>
            </div>
          ...
          <div class="collapse pc-user-links" id="pc_sidebar_userlink">
            <div class="pt-3">
              <a href="#!">
                ...
                <span data-i18n="Mon Compte">Mon Compte</span>
              </a>
              <a href="#!">
                <i class="ti ti-settings"></i>
                <span data-i18n="Parametres">Parametres</span>
              </a>
              ...
              <a href="#!">
                ...
                <span data-i18n="Se deconnecter">Se deconnecter</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <ul class="pc-navbar">
        <li class="pc-item pc-caption">
          <label data-i18n="Parametrage">Parametrage</label>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext" data-i18n="Utilisateurs & rôles">Utilisateurs & rôles</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <span class="pc-badge" style="display:none;">2</span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('utilisateur') }}" data-i18n="Créer utilisateurs">Créer utilisateurs</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('analytics') }}" data-i18n="Profils & permissions">Profils & permissions</a></li>
            <li class="pc-item"><a class="pc-link" href="{{ route('finance') }}" data-i18n="Affectation zones/sites">Affectation zones/sites</a></li>
          </ul>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext" data-i18n="Paramètres métier">Paramètres métier</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../demo/layout-vertical.html" data-i18n="Types d’activités correctives">Types d’activités correctives</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-horizontal.html" data-i18n="Types d’incidents">Types d’incidents</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-color-header.html" data-i18n="Layouts 2"  style="display:none;">Layouts 2</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-compact.html" data-i18n="Compact"  style="display:none;" >Compact</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-tab.html" data-i18n="Tab"  style="display:none;">Tab</a></li>
          </ul>
        </li>
                <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext" data-i18n="Paramètres métier">Autres Paramètres</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../demo/layout-vertical.html" data-i18n="Creation Projet">Creation Projet</a></li>
              </ul>
        </li>
        <li class="pc-item pc-caption">
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"
              ><a class="pc-link" href="../application/ecom_product-details.html" data-i18n="Product-Detail">Product details</a></li
            >
          ...
          <ul class="pc-submenu">
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                ...
                <li class="pc-item"
                  ><a class="pc-link" target="_blank" href="../pages/forgot-password-v1.html" data-i18n="Forget Password">Forgot Password</a></li
                >
                ...
                <li class="pc-item"
                  ><a class="pc-link" target="_blank" href="../pages/code-verification-v1.html" data-i18n="Code Verification"
                    >code verification</a
                  ></li
                >
              </ul>
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                ...
                <li class="pc-item"
                  ><a class="pc-link" target="_blank" href="../pages/code-verification-v2.html" data-i18n="Code Verification"
                    >code verification</a
                  ></li
                >
              </ul>
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                <li class="pc-item"
                  ><a class="pc-link" target="_blank" href="../pages/under-construction-v1.html" data-i18n="Under construction 1"
                    >Under Construction 1</a
                  ></li
                >
                <li class="pc-item"
                  ><a class="pc-link" target="_blank" href="../pages/under-construction-v2.html" data-i18n="Under construction 2"
                    >Under Construction 2</a
                  ></li
                >
              </ul>
            </li>
