      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a class="pc-link" href="{{ route('gestprofil') }}" data-i18n="Profils & permissions">Profils & permissions</a></li>
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../demo/layout-vertical.html" data-i18n="Types activités correctives">Types activités correctives</a></li>
            <li class="pc-item"><a class="pc-link" href="../demo/layout-horizontal.html" data-i18n="Types incidents">Types incidents</a></li>
          ...
          <a href="#!" class="pc-link">
            ...
            <span class="pc-mtext" data-i18n="Autres Paramètres">Autres Paramètres</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
          </a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('creationprojet') }}" data-i18n="Creation Projet">Creation Projet</a></li>
              </ul>
        </li>
        <li class="pc-item pc-caption">
