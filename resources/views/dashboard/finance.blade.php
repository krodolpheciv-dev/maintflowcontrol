                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-shrink-0">
                        <img src="{{ asset('assets/images/widget/img-card-master.svg') }}" alt="img" class="img-fluid" />
                      </div>
                    </div>
                ...
                <div class="row g-3">
                  <div class="col-md-6 col-xxl-3">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <img src="{{ asset('assets/images/widget/img-food.png') }}" alt="img" class="img-fluid" />
                          <div class="dropdown">
                            <a
                              class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                              href="#"
                  ...
                  <div class="col-md-6 col-xxl-3">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <img src="{{ asset('assets/images/widget/img-travel.png') }}" alt="img" class="img-fluid" />
                          <div class="dropdown">
                            <a
                              class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                              href="#"
                  ...
                  <div class="col-md-6 col-xxl-3">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <img src="{{ asset('assets/images/widget/img-shoping.png') }}" alt="img" class="img-fluid" />
                          <div class="dropdown">
                            <a
                              class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                              href="#"
                  ...
                  <div class="col-md-6 col-xxl-3">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                          <img src="{{ asset('assets/images/widget/img-helth.png') }}" alt="img" class="img-fluid" />
                          <div class="dropdown">
                            <a
                              class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                              href="#"
                  ...
                  <div class="col-12">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('assets/images/widget/img-card-1.png') }}" alt="img" class="img-fluid" />
                          </div>
                          <div class="flex-grow-1 ms-3">
                  ...
                  <div class="col-12">
                    <div class="card shadow-none border mb-0">
                      <div class="card-body p-3">
                        <div class="d-flex align-items-center">
                          <div class="flex-shrink-0">
                            <img src="{{ asset('assets/images/widget/img-card-2.png') }}" alt="img" class="img-fluid" />
                          </div>
                          <div class="flex-grow-1 ms-3">
                            <div class="d-flex align-items-center justify-content-center gap-2 text-success">
                              <i class="ti ti-circle f-10"></i>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 my-3">
                  ...
                  /></a>
                  <a href="#" class="avtar"
                    ><img class="rounded-circle img-fluid" src="{{ asset('assets/images/user/avatar-2.jpg') }}" alt="User image"
                  /></a>
                  <a href="#" class="avtar"
                    ><img class="rounded-circle img-fluid" src="{{ asset('assets/images/user/avatar-3.jpg') }}" alt="User image"
                  /></a>
                  <a href="#" class="avtar"
                    ><img class="rounded-circle img-fluid" src="{{ asset('assets/images/user/avatar-4.jpg') }}" alt="User image"
                  /></a>
                </div>
                <ul class="list-group list-group-flush">
                  <li class="list-group-item px-0">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img src="{{ asset('assets/images/widget/img-acitivity-3.svg') }}" alt="img" class="wid-30 rounded" />
                      </div>
                      <div class="flex-grow-1 ms-3">
                        <div class="row g-1">
                          <div class="col-6">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="{{ asset('assets/images/user/avatar-4.jpg') }}" alt="user image" class="img-radius wid-40" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="{{ asset('assets/images/user/avatar-5.jpg') }}" alt="user image" class="img-radius wid-40" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                              <h6 class="mb-0">Airi Satou</h6>
                            </div>
