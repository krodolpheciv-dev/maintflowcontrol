  ...
  let id = $(this).data('id');
    ...
    $.ajax({
        ...
        beforeSend:function(){
            ...
            // Facultatif : afficher un spinner
        ...
        success:function(data){
            ...
            $('#view_site').text(data.site.name);

            $('#view_incident').text(data.incident_type.name);

            $('#view_subincident').text(data.incident_sub_type.name);
            ...
            $('#view_creator').text(data.creator.name);
...
<script>
    ...
    switch(priority){
        ...
        default:
            return '<span class="badge bg-secondary">Faible</span>';
...
function getStatusBadge(status){
    ...
    switch(status){
        ...
        case 'Affectée':
            return '<span class="badge bg-warning">Affectée</span>';

        case 'Validée':
            return '<span class="badge bg-success">Validée</span>';

        case 'Clôturée':
            return '<span class="badge bg-dark">Clôturée</span>';
