      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        ...
        <div class="dropdown-body">
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            ...
            <a href="#" class="dropdown-item" style="display:none;">
              <span>
                <svg class="pc-icon text-muted me-2">
            ...
            <hr class="border-secondary border-opacity-50" style="display:none;" />
            <p class="text-span" style="display:none;">Team</p>
            <a href="#" class="dropdown-item" style="display:none;">
              <span >
                <svg class="pc-icon text-muted me-2">
            ...
            <div class="d-grid mb-3">
              <button class="btn btn-primary">
                <svg class="pc-icon me-2">
                  <use xlink:href="#custom-logout-1-outline"></use></svg>Se deconnecter
              </button>
            </div>
            <div
              class="card border-0 shadow-none drp-upgrade-card mb-0"
              style="background-image: url(../assets/images/layout/img-profile-card.jpg);display:none;"
               >
              <div class="card-body">
                <div class="user-group">
                  <img src="{{ asset('assets/images/user/avatar-1.jpg') }}" alt="user-image" class="avtar" />
